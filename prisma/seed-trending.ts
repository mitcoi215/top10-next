// prisma/seed-trending.ts
// Seed script to populate Trending List data for homepage
...
async function main() {
  console.log('🌱 Starting trending items seed...');

  // Find or create HomepageSettings
  ...
  if (settings) {
    ...
    console.log('✓ Updated HomepageSettings with trendingItems');
  } else {
    // Create new settings
  ...
  console.log('✅ Trending items seed completed!');
  console.log(`   Total items: ${trendingItemsData.length}`);
}
